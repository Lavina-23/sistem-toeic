<x-layout>
    ...
    <section class="p-4 md:ml-64 h-auto mt-10 md:mt-0">
        <div class="max-w-6xl mx-auto p-6 mt-20 bg-white rounded shadow">
            @if ($registered)
                <div class="flex flex-col justify-center items-center md:flex-row gap-5 w-full">
                    ...
                    <path d="M319 215L370.5 175.5L361.5 238.5L320.5 255L319 215Z"
                        fill="url(#paint2_linear_344_2578)" />
                    <path
                    ...
                    <defs>
                        ...
                        <linearGradient id="paint10_linear_344_2578" x1="458" y1="383"
                            x2="387.5" y2="234.5" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#7F270F" />
                            <stop offset="1" stop-color="#7F270F" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint11_linear_344_2578" x1="324.824" y1="257.763"
                            x2="266.641" y2="189.301" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#7F270F" />
                            <stop offset="1" stop-color="#7F270F" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint12_linear_344_2578" x1="143.501" y1="-117.5"
                            x2="225.755" y2="243.308" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#0d9488" />
                            <stop offset="1" stop-color="#0d9488" stop-opacity="0" />
                        </linearGradient>
                    </defs>
                ...
                <form method="POST" action="{{ route('peserta.store') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="no_induk" class="mt-1 block w-full" type="text" name="no_induk" :value="old('no_induk')" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="nik" class="mt-1 block w-full" type="text" name="nik" :value="old('nik')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="no_telp" class="mt-1 block w-full" type="text" name="no_telp" :value="old('no_telp')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="jurusan" class="mt-1 block w-full" type="text" name="jurusan" :value="old('jurusan')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="program_studi" class="mt-1 block w-full" type="text" name="program_studi" :value="old('program_studi')" required />
                        ...
                        <div>
                            ...
                            <select id="kampus" name="kampus" class="mt-1 block w-full bg-white border-gray-300 rounded-md shadow-sm focus:ring-teal-500" required>
                                <option value="">{{ __('daftar.pilih_kampus') }}</option>
                                @foreach (['Utama', 'PSDKU Kediri', 'PSDKU Lumajang', 'PSDKU Pamekasan'] as $option)
                                    <option value="{{ $option }}" {{ old('kampus') === $option ? 'selected' : '' }}>{{ $option }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <textarea id="alamat_asal" name="alamat_asal" class="mt-1 block w-full border-gray-300 focus:ring-teal-500 rounded-md shadow-sm" rows="3" required>{{ old('alamat_asal') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="alamat_sekarang" name="alamat_sekarang" class="mt-1 block w-full border-gray-300 focus:ring-teal-500 rounded-md shadow-sm" rows="3" required>{{ old('alamat_sekarang') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input id="ktp" class="mt-1 block w-full" type="file" name="ktp" required />
                            <x-input-error :messages="$errors->get('ktp')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="ktm" :value="__('daftar.ktm')" />
                            <input id="ktm" class="mt-1 block w-full" type="file" name="ktm" required />
                            <x-input-error :messages="$errors->get('ktm')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="foto" :value="__('daftar.foto')" />
                            <input id="foto" class="mt-1 block w-full" type="file" name="foto" required />
