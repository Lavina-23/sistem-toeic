            ...
            <div class="bg-white border rounded-lg shadow-sm p-6">
                ...
                <div class="w-full flex flex-col items-center">
                    ...
                    <div class="w-full h-[600px] border border-gray-300 rounded-lg overflow-hidden mb-4">
                        <object 
                            data="{{ asset('pdf/jadwal-toeic.pdf') }}" 
                    ...
                    <!-- Download Button -->
                    <a href="{{ asset('pdf/jadwal-toeic.pdf') }}" download class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-white bg-teal-600 hover:bg-teal-700 rounded-lg focus:ring-4 focus:ring-teal-200">
                ...
                <div class="space-y-4 text-sm font-normal text-gray-600">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <svg class="w-5 h-5 text-teal-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
