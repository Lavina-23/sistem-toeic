<x-layout>
    <x-sidebar />
    <section class="p-4 md:ml-60 h-auto mt-10 md:mt-0 bg-gray-50 min-h-screen flex flex-col md:flex-row gap-6">
        ...
        @else
            <div class="w-full md:w-1/2">
                <div class="border-2 rounded-xl shadow-md p-8 bg-white grid justify-items-center">
                    <h2 class="text-2xl font-bold text-gray-800 mb-3">Hasil Tes</h2>
                    <svg class="w-auto max-w-[20rem] h-36 text-gray-800 dark:text-white" aria-hidden="true"
                        width="433" height="559" viewBox="0 0 433 559" fill="none"
                        ...
                        <path
                            ...
                            fill="#374151" />
                        <defs>
                            <linearGradient id="paint0_linear_275_1403" x1="185.944" y1="389.817" x2="168.992"
                                y2="453.085" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#33eddd" />
                                <stop offset="1" stop-color="#33eddd" stop-opacity="0" />
                            </linearGradient>
                            <linearGradient id="paint1_linear_275_1403" x1="200.311" y1="392.967" x2="183.008"
                                y2="457.54" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#33eddd" />
                                <stop offset="1" stop-color="#33eddd" stop-opacity="0" />
                            </linearGradient>
                            <linearGradient id="paint2_linear_275_1403" x1="171.93" y1="385.362" x2="154.627"
                                y2="449.935" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#33eddd" />
                                <stop offset="1" stop-color="#33eddd" stop-opacity="0" />
                            </linearGradient>
                            <linearGradient id="paint3_linear_275_1403" x1="180.033" y1="403.222" x2="180.033"
                                y2="430.222" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#111928" />
                                <stop offset="1" stop-color="#111928" stop-opacity="0" />
                            </linearGradient>
                            <linearGradient id="paint4_linear_275_1403" x1="258.705" y1="119.953" x2="193.353"
                                y2="363.849" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#70f2e7" />
                                <stop offset="1" stop-color="#70f2e7" stop-opacity="0" />
                            </linearGradient>
                            <linearGradient id="paint5_linear_275_1403" x1="211.663" y1="295.768" x2="185.781"
                                y2="392.361" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#0d9488" />
                                <stop offset="1" stop-color="#0d9488" stop-opacity="0" />
                            </linearGradient>
                            <linearGradient id="paint6_linear_275_1403" x1="22" y1="-28.5" x2="22"
                                y2="69" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#111928" />
                                <stop offset="1" stop-color="#111928" stop-opacity="0" />
                            </linearGradient>
                        </defs>
                    </svg>
                    <p class="text-gray-600 text-sm w-52 text-center">Hasil tes TOEIC kamu nanti akan ditampilkan
                        disini.
                    </p>
                </div>
            </div>
