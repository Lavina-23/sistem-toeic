                                            ...
                                            @if($pengumuman->file)
                                                ...
                                                <div class="flex flex-col items-center space-y-2">
                                                    @if($fileExtension === 'pdf')
                                                        <div class="w-16 h-20 bg-red-100 rounded border border-red-200 flex items-center justify-center">
                                                            <span class="text-red-600 text-xs font-bold">PDF</span>
                                                        </div>
                                                    @else
                                                        <div class="w-16 h-20 bg-gray-100 rounded border border-gray-200 flex items-center justify-center">
                                                            <span class="text-gray-600 text-xs">FILE</span>
                                                        </div>
                                                    @endif
                    ...
                    <div class="overflow-x-auto shadow-lg rounded-lg border border-gray-200">
                        <div class="bg-white p-16 text-center">
                            <div class="flex flex-col items-center justify-center space-y-4">
                                ...
                                @else
                                    <p class="text-sm text-gray-500">Belum ada pengumuman yang terdaftar</p>
                                @endif
                            </div>
                        </div>
                    </div>
