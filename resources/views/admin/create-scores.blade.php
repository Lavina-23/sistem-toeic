                        ...
                        <div class="flex flex-col lg:flex-row gap-4">
                            <div class="flex-[3]">
                                <div class="relative">
                                    ...
                                    <input type="text" id="searchInput" placeholder="🔍 {{__('scoreAdmin.search')}}"
                            ...
                            <div class="flex flex-wrap gap-3 flex-[3]">
                                <select id="categoryFilter" class="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white min-w-[220px]">
                                    <option value="">🏷️&nbsp;{{__('scoreAdmin.kategori')}}</option>
                                ...
                                <select id="groupFilter" class="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white min-w-[220px]">
                                    <option value="">👥&nbsp;{{__('scoreAdmin.grup')}}</option>
                    ...
                    <table class="min-w-full table-fixed border-collapse bg-white">
                        <thead>
                            <tr class="bg-gradient-to-r from-gray-50 to-gray-100 border-b-2 border-gray-200">
                                ...
                                <th class="w-28 px-4 py-4 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider border-r border-gray-200">{{__('scoreAdmin.ScrL')}}</th>
                                <th class="w-28 px-4 py-4 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider border-r border-gray-200">{{__('scoreAdmin.ScrR')}}</th>
