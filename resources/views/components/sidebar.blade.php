<x-layout>
    <section class="antialiased bg-gray-50 dark:bg-gray-900">
        <nav
            class="md:hidden bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        ...
        <!-- Sidebar -->
        <aside
            class="fixed top-0 left-0 z-40 w-64 h-screen pt-1 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
            aria-label="Sidenav" id="drawer-navigation">
            <div class="overflow-y-auto py-5 px-3 h-screen bg-white dark:bg-gray-800">
                <ul class="space-y-2">
                    <li>
                        <div
                            ...
                            <div class="flex flex-col items-center pb-10">
                                ...
                                <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Lavina</h5>
                                <span class="text-sm text-gray-500 dark:text-gray-400">D4 - Sistem Informasi
                                    Bisnis</span>
                ...
                <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                    <li>
                        <a href="{{ route('peserta.create') }}"
                            ...
                            <span class="ml-3">Daftar Test 🚀</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
            ...
            <div
                class="absolute bottom-0 left-0 justify-start p-4 space-x-4 w-full flex bg-white dark:bg-gray-800 z-20">
                <button
                    class="w-full flex items-center p-2 text-base font-medium text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
                    ...
                    <span class="ml-3">Indonesia</span>
                </button>
                <!-- Dropdown -->
