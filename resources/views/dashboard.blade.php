<x-layout>
    ...
    <section class="p-4 md:ml-64 h-auto mt-10 md:mt-0">
        <div class="flex flex-wrap justify-between gap-3 md:gap-0">
            <a href="#"
                class="flex w-full md:w-60 lg:w-72 gap-2 p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <svg class="w-12 md:w-16 h-12 md:h-16 text-gray-800 dark:text-white" aria-hidden="true"
                ...
                <div>
                    <h5
                        class="mb-0 md:mb-2 text-lg md:text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                        Total
                        Tes</h5>
                    <span class="font-medium text-base md:text-lg text-gray-700 dark:text-gray-400">1</span>
                </div>
            </a>
            <a href="#"
                class="flex w-full md:w-60 lg:w-72 gap-2 p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <div>
                    ...
                    <span class="font-medium text-base md:text-lg text-gray-700 dark:text-gray-400">0</span>
                </div>
            </a>
            <a href="#"
                class="flex w-full mt-0 md:mt-1 lg:mt-0 md:w-60 lg:w-72 gap-2 p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <svg class="w-12 md:w-16 h-12 md:h-16 text-gray-800 dark:text-white" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path
                ...
                <div>
                    <h5
                        ...
                        Tes
                        Selesai</h5>
                    <span class="font-medium text-base md:text-lg text-gray-700 dark:text-gray-400">2</span>
                </div>
            </a>
        </div>
        <div
            class="max-w-full p-6 mt-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <div class="grid justify-items-center lg:flex gap-6">
                <svg class="w-auto max-w-[16rem] md:max-w-[18rem] h-48 md:h-52 text-gray-800 dark:text-white"
                    aria-hidden="true" width="556" height="421" viewBox="0 0 556 421" fill="none"
                    ...
                    <path
                        ...
                        fill="url(#paint0_linear_344_2578)" />
                    <path
                    ...
                    <path
                        d="M213.135 331.449L61.8143 358.18C60.7892 358.361 60.0744 359.298 60.1708 360.334L63.8089 399.444C63.9135 400.569 64.9283 401.384 66.0491 401.243L227.5 381L374 402.5L295 333L241.056 329.827C231.717 329.278 222.347 329.822 213.135 331.449Z"
                        fill="url(#paint1_linear_344_2578)" />
                    ...
                    <path
                        d="M381.4 161.329L373.235 138.538L383.314 125.911L397.446 151.154C394.774 155.78 385.16 160.02 381.4 161.329Z"
                        fill="url(#paint3_linear_344_2578)" />
                    <path
                    ...
                    <path
                        d="M377.5 403C426.3 402.6 428.167 335 423 301.5L371.5 294.5C348.834 279.667 299.7 247.3 284.5 236.5C265.5 223 246.5 222 229.5 240.5C216.294 254.871 170.903 323.523 147.989 358.924C147.128 360.254 148.088 362 149.672 362H205.408C206.089 362 206.723 361.654 207.091 361.081L255 286.5C275.5 325.333 328.7 403.4 377.5 403Z"
                        fill="url(#paint4_linear_344_2578)" />
                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <path
                        ...
                        fill="url(#paint6_linear_344_2578)" />
                    <path
                    ...
                    <path
                        d="M379.998 165.5C379.598 162.7 380.498 160.667 380.998 160C388.198 158.8 394.998 153.5 397.498 151C400.298 151.8 402.665 153.333 403.498 154C402.998 155 400.598 157.8 394.998 161C389.398 164.2 382.665 165.333 379.998 165.5Z"
                        fill="url(#paint7_linear_344_2578)" />
                    <path
                    ...
                    <path
                        d="M333.5 156.443C330 125 292.667 125.499 284 125C274.4 125 268.667 129.658 267 131.987C281.5 138.975 287.5 158.939 281 193.876C274.5 228.813 281 283.215 314 321.646C347 360.077 432 338.616 453.5 366.066C469.341 386.292 488.943 397.91 498.712 402.088C500.217 402.732 501.837 403 503.473 403H556C533.5 403 510 373.553 493 357.582C476 341.61 431.5 346.102 404 341.61C376.5 337.118 349 308.67 336 271.237C323 233.804 336.85 186.54 333.5 156.443Z"
                        fill="url(#paint8_linear_344_2578)" />
                    <path
                        d="M333.5 156.443C330 125 292.667 125.499 284 125C274.4 125 268.667 129.658 267 131.987C281.5 138.975 287.5 158.939 281 193.876C274.5 228.813 281 283.215 314 321.646C347 360.077 432 338.616 453.5 366.066C469.341 386.292 488.943 397.91 498.712 402.088C500.217 402.732 501.837 403 503.473 403H556C533.5 403 510 373.553 493 357.582C476 341.61 431.5 346.102 404 341.61C376.5 337.118 349 308.67 336 271.237C323 233.804 336.85 186.54 333.5 156.443Z"
                        fill="url(#paint9_linear_344_2578)" />
                    <path
                    ...
                    <path
                        d="M308.5 199C311 212 336 240 364.5 291L373 268C360.667 251.666 335.3 217.6 332.5 212C329.99 206.981 326.758 201.319 324.674 198.398C324.286 197.854 323.575 197.669 322.955 197.918C322.159 198.236 321.784 199.15 322.128 199.935L325 206.5C319.333 199.666 306.535 188.779 308.5 199Z"
                        fill="url(#paint10_linear_344_2578)" />
                    <path
                    ...
                    <path
                        d="M296.5 154C296.1 157.2 287.667 166.667 283.5 171C283 186 281 195.167 279.5 205C277.167 194.333 273.2 171.2 276 164C279.5 155 289 150.5 291.5 150C294 149.5 297 150 296.5 154Z"
                        fill="url(#paint11_linear_344_2578)" />
                    <path
                    ...
                    <path
                        d="M240.501 223.177C216.483 339.537 148.832 390.702 116.516 402.468C115.495 402.84 114.446 403 113.359 403H76.6508C75.6336 403 75.2329 401.646 76.092 401.102C96.6434 388.075 138.312 354.13 163.001 307.328C195.501 245.717 195.001 196.629 206.001 161.566C214.801 133.515 232.667 125.501 240.501 125H284.001C255.601 125 245.256 200.135 240.501 223.177Z"
                        fill="url(#paint12_linear_344_2578)" fill-opacity="0.5" />
                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <path
                        ...
                        fill="#9ab7f6" />
                    <defs>
                        <linearGradient id="paint0_linear_344_2578" x1="328" y1="0" x2="328"
                            y2="378" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#1F2A37" />
                            <stop offset="1" stop-color="#1F2A37" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint1_linear_344_2578" x1="598" y1="-82.4999" x2="333.419"
                            y2="-166.998" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#111928" />
                            <stop offset="1" stop-color="#111928" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint2_linear_344_2578" x1="385" y1="255" x2="330.615"
                            y2="169.856" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#c8d8fa" />
                            <stop offset="1" stop-color="#c8d8fa" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint3_linear_344_2578" x1="384.784" y1="118.92" x2="389.359"
                            y2="152.011" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#7F270F" />
                            <stop offset="1" stop-color="#7F270F" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint4_linear_344_2578" x1="393" y1="1.49999" x2="279.816"
                            y2="20.445" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#111928" />
                            <stop offset="1" stop-color="#111928" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint5_linear_344_2578" x1="421.5" y1="239" x2="448.603"
                            y2="298.071" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#c8d8fa" />
                            <stop offset="1" stop-color="#c8d8fa" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint6_linear_344_2578" x1="376.5" y1="281.5" x2="369.288"
                            y2="243.828" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#c8d8fa" />
                            <stop offset="1" stop-color="#c8d8fa" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint7_linear_344_2578" x1="397.847" y1="170.172" x2="396.12"
                            y2="156.768" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#c8d8fa" />
                            <stop offset="1" stop-color="#c8d8fa" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint8_linear_344_2578" x1="556" y1="458.5" x2="303.5"
                            y2="257.5" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#d6e2fb" />
                            <stop offset="1" stop-color="#d6e2fb" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint9_linear_344_2578" x1="329.5" y1="10" x2="387.5"
                            y2="208" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#2563eb" />
                            <stop offset="1" stop-color="#2563eb" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint10_linear_344_2578" x1="458" y1="383" x2="387.5"
                            y2="234.5" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#7F270F" />
                            <stop offset="1" stop-color="#7F270F" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint11_linear_344_2578" x1="324.824" y1="257.763" x2="266.641"
                            y2="189.301" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#7F270F" />
                            <stop offset="1" stop-color="#7F270F" stop-opacity="0" />
                        </linearGradient>
                        <linearGradient id="paint12_linear_344_2578" x1="143.501" y1="-117.5" x2="225.755"
                ...
                <div class="text-center lg:text-left">
                    ...
                    <span class="font-medium text-sm text-gray-300">Tes akan dilaksanakan dalam waktu:</span>
                    @php
                        $date = \Illuminate\Support\Carbon::parse('2025-03-15 09:00:00');
                    @endphp

                    <x-countdown :expires="$date"
                        class="flex justify-center lg:justify-start gap-2 mt-1 text-lg md:text-sm lg:text-2xl text-white font-bold">
                        <div class="grid md:flex gap-2">
                            <div class="border-2 border-white border-dashed w-full md:w-fit py-1 px-3 rounded-lg">
            ...
            <div class="flex flex-col md:flex-row md:gap-8 mt-5 lg:mt-0">
                <dl class="w-full text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    <div class="flex flex-col pb-3">
                        ...
                        <dd class="text-sm lg:text-base font-semibold">10210153954230624</dd>
                    </div>
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 text-xs dark:text-gray-400">
                            Kode Ujian</dt>
                        <dd class="text-sm lg:text-base font-semibold">U-021-05327</dd>
                    </div>
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 text-xs dark:text-gray-400">
                            Nama Ujian</dt>
                        <dd class="text-sm lg:text-base font-semibold">Uji UKBI Adaptif 2</dd>
                    </div>
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 text-xs dark:text-gray-400">
                            Mendaftar Sebagai</dt>
                        <dd class="text-sm lg:text-base font-semibold">Mahasiswa</dd>
                    </div>
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 text-xs dark:text-gray-400">
                            Tujuan Tes</dt>
                        <dd class="text-sm lg:text-base font-semibold">Pendaftaran beasiswa</dd>
                    </div>
                </dl>
                <dl class="w-full text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 text-xs dark:text-gray-400">
                            Jenis Pembayaran</dt>
                        <dd class="text-sm lg:text-base font-semibold">Biaya Mandiri</dd>
                    </div>
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 text-xs dark:text-gray-400">
                            Tanggal Penutupan Pembayaran</dt>
                        <dd class="text-sm lg:text-base font-semibold">Sabtu, 29 Juni 2024 23:59:00</dd>
                    </div>
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 text-xs dark:text-gray-400">
                            Tanggal Ujian</dt>
                        <dd class="text-sm lg:text-base font-semibold">01 Juli 2024 10:00:00 s.d 01 Juli 2024 13:05:00
                        </dd>
                    </div>
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 text-xs dark:text-gray-400">
                            Zona Waktu</dt>
                        <dd class="text-sm lg:text-base font-semibold">Asia/Jakarta</dd>
                    </div>
                    <div class="flex flex-col pb-3">
                        <dt class="mb-1 text-gray-500 text-xs dark:text-gray-400">
                            Status</dt>
                        <dd class="text-sm lg:text-base font-semibold">Selesai</dd>
                    </div>
                </dl>
            </div>
        </div>
